...
cd epusdt
wget https://github.com/guyuxiang/scplus-pay/releases/download/v0.0.3/epusdt_0.0.3_Linux_x86_64.tar.gz
...
```bash
 ...
 |_____| .__/ \__,_|___/\__,_|\__|
       |_|                        
Epusdt version(0.0.2) Powered by GMWalletApp https://github.com/guyuxiang/scplus-pay
