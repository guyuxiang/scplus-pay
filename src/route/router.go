...
import (
	...
	"github.com/guyuxiang/scplus-pay/controller/admin"
	"github.com/guyuxiang/scplus-pay/controller/comm"
	...
	"github.com/guyuxiang/scplus-pay/util/sign"
...
func RegisterRoute(e *echo.Echo) {
	e.POST("/", func(c echo.Context) error {
		return c.String(http.StatusOK, "hello epusdt, https://github.com/guyuxiang/scplus-pay")
	})
