...
> 具体支持的链与代币以 [最新版本](https://github.com/guyuxiang/scplus-pay/releases) 及 [官方文档](https://epusdt.com) 为准。
...
**遇到问题？** 请优先在 GitHub 提交 [Issue](https://github.com/guyuxiang/scplus-pay/issues)，我们会优先处理反馈。
