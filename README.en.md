...
<p align="center">
  <a href="https://github.com/guyuxiang/scplus-pay/stargazers"><img src="https://img.shields.io/github/stars/guyuxiang/scplus-pay?style=flat-square&color=f5c542" alt="GitHub Stars 3000+"></a>
  ...
  <a href="https://github.com/guyuxiang/scplus-pay/releases"><img src="https://img.shields.io/github/v/release/guyuxiang/scplus-pay?style=flat-square&color=green" alt="Latest Release"></a>
</p>
...
> Actual support depends on the [latest release](https://github.com/guyuxiang/scplus-pay/releases) and the [official docs](https://epusdt.com).
...
If you hit an issue, please open a [GitHub Issue](https://github.com/guyuxiang/scplus-pay/issues) first. That is the best way to get attention and help.
...
<a href="https://www.star-history.com/?type=date&repos=gmwalletapp%2Fepusdt">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=guyuxiang/scplus-pay&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=guyuxiang/scplus-pay&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=guyuxiang/scplus-pay&type=date&legend=top-left" />
 </picture>
</a>
